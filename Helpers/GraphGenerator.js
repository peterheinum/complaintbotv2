    ...
    view
      ...
      .then(function (canvas) {
        ...
        fs.writeFile("stackedBarChart.png", canvas.toBuffer(), function (
          ...
          console.log("graph created, attemptinasaaaaaaaaaaaaaaaaaaaaaaaaaag upload");
          request.post(
            {
              url: "https://slack.com/api/files.upload",
              formData: {
      ...
      "data": [
        {
          "name": "table",
          "values": [
            { "id": parseInt(data[0].time), "field": data[0].temp },
            { "id": parseInt(data[1].time), "field": data[1].temp },
            { "id": parseInt(data[2].time), "field": data[2].temp },
            { "id": parseInt(data[3].time), "field": data[3].temp },
            { "id": parseInt(data[4].time), "field": data[4].temp },
            { "id": parseInt(data[5].time), "field": data[5].temp },
            { "id": parseInt(data[6].time), "field": data[6].temp },
            { "id": parseInt(data[7].time), "field": data[7].temp },
            { "id": parseInt(data[8].time), "field": data[8].temp },
            { "id": parseInt(data[9].time), "field": data[9].temp },
            { "id": parseInt(data[10].time), "field": data[10].temp },
            { "id": parseInt(data[11].time), "field": data[11].temp },
            { "id": parseInt(data[12].time), "field": data[12].temp },
            { "id": parseInt(data[13].time), "field": data[13].temp },
            { "id": parseInt(data[14].time), "field": data[14].temp },
            { "id": parseInt(data[15].time), "field": data[15].temp },
            { "id": parseInt(data[16].time), "field": data[16].temp },
            { "id": parseInt(data[17].time), "field": data[17].temp },
            { "id": parseInt(data[18].time), "field": data[18].temp },
            { "id": parseInt(data[19].time), "field": data[19].temp },
            { "id": parseInt(data[20].time), "field": data[20].temp },
            { "id": parseInt(data[21].time), "field": data[21].temp },
            { "id": parseInt(data[22].time), "field": data[22].temp },
            { "id": parseInt(data[23].time), "field": data[23].temp },
          ],
          "transform": [
            {
              "type": "pie",
